...
public class Stock {
 ...
 public static void main(String[] args) throws InterruptedException, IOException {
        ...
        System.setProperty("webdriver.chrome.driver","C:\\Users\\SWBHARAD\\Downloads\\chromedriver_win32 (1)\\chromedriver.exe");
        WebDriver driver= new ChromeDriver();
        driver.manage().window().maximize();

        //driver.get("www1.nseindia.com");
        ...
        Thread.sleep(3000);
            ...
            File file = new File("C:\\Users\\SWBHARAD\\eclipse-workspace\\Stocks\\Result\\stockData.csv");
